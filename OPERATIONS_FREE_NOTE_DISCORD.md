...
この機能は、政治・制度解説の無料note原稿を通常週2本、強い勝ちテーマがある週は最大3本まで候補生成し、ローカルMarkdownを正本として保存します。Discordは通知と人間確認だけに使います。
...
3. 公式一次資料を最低2件、推奨2〜5件確認
4. ISBN確認済み書籍カタログから、記事種別・タイトルに合う関連書籍を0〜3冊選定
